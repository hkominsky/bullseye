...
class EmailBuilder:
    ...
    Responsible for DataFrame formatting, HTML generation, and content preparation.
    """
    ...
    def build_html_content(self, raw_df: pd.DataFrame, metrics_df: pd.DataFrame) -> str:
        """
        Formats the DataFrames and builds the complete HTML email content.
        This is a convenience method that handles all formatting and content generation in one call.
        ...
        Returns:
            Complete HTML email content as a string
        """
        ...
        return self.build_email_content(filtered_raw_df, filtered_metrics_df)